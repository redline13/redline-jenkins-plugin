 ...
 */
public class RedlinePublisher extends Notifier {
	
	private String apiKey;
	
	private String templateId = "";

  private double errorFailedThreshold = 0;

  private double errorUnstableThreshold = 0;
  ...
  PrintStream log = new PrintStream(System.out);
	...
	public RedlinePublisher( String apiKey,
							            String templateId,
							            double errorFailedThreshold,
							            double errorUnstableThreshold,
    ...
    for (RedlineCredential c : CredentialsProvider
            .lookupCredentials(RedlineCredential.class, build.getProject(), ACL.SYSTEM)) {
	...
	public double getErrorUnstableThreshold() {
		return errorUnstableThreshold;
	}
	
	public void setErrorUnstableThreshold(double errorUnstableThreshold) {
		this.errorUnstableThreshold = Math.max(0.0, Math.min(errorUnstableThreshold, 100.0));
	}
